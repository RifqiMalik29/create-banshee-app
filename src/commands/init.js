...
`;
  ...
  await createFile(path.join(projectPath, 'src/config/queryClient.ts'), queryClientContent);
...
`;
  ...
  await createFile(path.join(projectPath, 'src/store/authSlice.ts'), authSliceContent);
  ...
  await createFile(path.join(projectPath, 'src/store/index.ts'), `export * from './store';\nexport * from './hooks';\nexport * from './authSlice';`);
};
...
`;
  ...
  await createFile(path.join(projectPath, 'src/store/authStore.ts'), authStoreContent);
  await createFile(path.join(projectPath, 'src/store/index.ts'), `export * from './authStore';`);
};
